...
export function WelcomeScreen({ onStart }) {
  return (
    <div className="flex flex-1 flex-col items-center px-6 pt-12 pb-6 text-center bg-[radial-gradient(130%_80%_at_50%_6%,rgba(16,196,168,0.18),var(--color-cream)_60%)]">
