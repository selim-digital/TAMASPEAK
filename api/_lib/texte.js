 ...
 * Les mains ORDINAIRES et les traces de pattes restent — pas d'yeux :
 * U+1F64C (mains levées), U+1F918–1F91F (gestes), U+1F933 (bras),
 * U+1F43E (empreintes). Les GESTES DE PRIÈRE partent en revanche
 * (décision de Selim) : U+1F64F (mains jointes) et U+1F932 (paumes
 * vers le ciel).
 */
const PLAGE_VISAGES =
  /[\u{2639}\u{263A}\u{1F31A}-\u{1F31E}\u{1F400}-\u{1F43D}\u{1F43F}-\u{1F445}\u{1F464}-\u{1F487}\u{1F600}-\u{1F64B}\u{1F64D}-\u{1F64F}\u{1F910}-\u{1F917}\u{1F920}-\u{1F932}\u{1F934}-\u{1F93E}\u{1F970}-\u{1F97A}\u{1F9B8}\u{1F9B9}\u{1F980}-\u{1F9AE}\u{1F9D0}-\u{1F9DF}\u{1FAC2}\u{1FAE0}-\u{1FAE8}\u{1F3FB}-\u{1F3FF}\u{200D}]/gu
